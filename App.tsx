...
const App: React.FC = () => {
          ...
          <>
            ...
            <div className="py-16 bg-[#0c0c0c]">
              <div className="max-w-7xl mx-auto px-4 text-center">
                <p className="italic font-serif text-xl text-stone-400">
  ...
  return (
    <div className="min-h-screen bg-[#0c0c0c] text-stone-200 antialiased selection:bg-amber-600 selection:text-white">
      <Navbar 
