...
export const Hero: React.FC<HeroProps> = ({ onStart, onImpact }) => {
  return (
    <div className="relative bg-[#0c0c0c] min-h-[85vh] lg:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 pt-44 sm:pt-48 lg:pt-56 pb-12">
        <div className="max-w-4xl animate-app-reveal">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[4rem] font-black font-serif mb-4 sm:mb-5 leading-[1.1] tracking-tighter text-white">
